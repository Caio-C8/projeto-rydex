...
export default function CorridaEmAndamentoScreen() { // <-- Nome da função mudado (opcional, mas bom)
  ...
  const handleFinalizar = () => {
    Alert.alert('Entrega Finalizada!', 'A rota foi concluída.');
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.chegueiButton} onPress={handleFinalizar}>
