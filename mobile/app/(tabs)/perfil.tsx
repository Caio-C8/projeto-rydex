...
const ProfileScreen: React.FC = () => {
  ...
  const [initialData, setInitialData] =
    useState<Partial<EntregadorPerfil> | null>(null);
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const docFile: ImageFile | undefined = veiculoDoc
        ? {
            uri: veiculoDoc.uri,
            name: veiculoDoc.name,
            type: veiculoDoc.type || "image/jpeg",
          }
        : undefined;
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Text style={[styles.loadingText, { color: themeColors.textGray }]}>
            Carregando perfil...
          </Text>
        </View>
      </SafeAreaView>
      ...
      >
        ...
        >
          <View>
            ...
            <Text
              style={[styles.headerSubtitle, { color: themeColors.textGray }]}
            >
              Meus dados
            </Text>
          </View>
          ...
          >
            <Text
              style={[styles.logoutButtonText, { color: themeColors.text }]}
            >
              Sair
            </Text>
            <Feather
        ...
        >
          ...
          <View style={styles.row}>
            <View style={{ flex: 1, marginRight: horizontalScale(8) }}>
              <EditableInput
                label="Celular:"
                value={celular}
                onChangeText={(text) => setCelular(maskPhoneNumber(text))}
          ...
          <View style={[styles.row, { marginTop: verticalScale(16) }]}>
            <DocumentPicker
              label="CNH:"
              document={cnhDoc}
              onPickDocument={() => handlePickImage(setCnhDoc)}
              themeColors={themeColors}
            />
            <DocumentPicker
              label="Doc. veículo:"
              document={veiculoDoc}
              onPickDocument={() => handlePickImage(setVeiculoDoc)}
              themeColors={themeColors}
            />
          </View>
