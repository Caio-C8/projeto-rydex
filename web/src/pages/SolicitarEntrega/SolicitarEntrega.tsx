...
export function SolicitarEntrega() {
  ...
  const [form, setForm] = useState({
    cep: '', cidade: '', numero: '', bairro: '', logradouro: '',
    complemento: '', ponto_referencia: '', item_retorno: false,
    descricao_item_retorno: '', observacao: ''
  });
  ...
  return (
    <div className="solicitar-container">
      ...
      <div className="solicitar-header">
        <h1 className="solicitar-titulo">Nova Solicitação</h1>
      </div>
      ...
      <div className="solicitar-form-wrapper">
        <Card>
          <form onSubmit={handleSimular} className="form-entrega">
            ...
            <div className="form-section">
              ...
              <div className="form-row row-logradouro">
                <div className="col-rua">
                  <Input label="Logradouro *" name="logradouro" value={form.logradouro} onChange={handleChange} placeholder="Nome da rua" />
                </div>
            ...
            {/* SEÇÃO DETALHES */}
            <div className="form-section">
              <h3 className="section-title"><FaBoxOpen className="icon-orange" /> Detalhes</h3>
              <div className="form-row">
                <div className="col-full">
                  <Input label="Observação" name="observacao" value={form.observacao} onChange={handleChange} placeholder="Ex: Caixa frágil..." />
                </div>
              </div>
              ...
              <div className="retorno-container">
                ...
                {form.item_retorno && (
                  <div className="retorno-input anime-slide-down">
                    <Input label="Descrição do retorno" name="descricao_item_retorno" value={form.descricao_item_retorno} onChange={handleChange} placeholder="Ex: Contrato..." />
                  </div>
                )}
              </div>
            </div>
            ...
            <div className="form-actions-center">
              <BotaoTexto 
                texto={simulando ? "CALCULANDO ROTA..." : "CONTINUAR PARA PAGAMENTO"} 
                type="submit" 
                corFundo="#FF5722" 
              />
            </div>
